...
class PeopleListModel {
  ...
  factory PeopleListModel.fromJson(Map<String, dynamic> json) =>
      PeopleListModel(
        ...
        results: List<PeopleListItem>.from(
            json["results"].map((x) => PeopleListItem.fromJson(x))),
      );
...
class PeopleListItem {
  ...
  factory PeopleListItem.fromJson(Map<String, dynamic> json) => PeopleListItem(
        name: json["name"],
        height: json["height"],
        mass: json["mass"],
